...
def train_xray_model(dataset_path, model_output_path):
...
if __name__ == "__main__":
    dataset_path = "datasets/xray"
    model_output_path = "models/xray_model.h5"
    if os.path.exists(dataset_path):
        train_xray_model(dataset_path, model_output_path)
    else:
